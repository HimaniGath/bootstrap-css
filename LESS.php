...
<html lang="en">
    ...
    <body>
        <form action="LESS.php" method="post">
            <div ><div>
                            ...
                            <div class="col-md-4">
                                <!-- ngRepeat: variable in group.data --><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    ...
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="component-active-bg" type="color"  data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()" value="<?php echo$cAB; ?>">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
            ...
            ================================================== --><span class="ng-scope">
                    ...
                    </section><section ng-repeat="group in variables" class="Private">
                        <div class="row protected">
                            <div class="col-md-12">
                                <h2 class="groupNameTitle ng-binding" name="Private">Private</h2>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <!-- ngRepeat: variable in group.data --><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@zindex-navbar</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="zindex-navbar" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@zindex-dropdown</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="zindex-dropdown" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@zindex-popover</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="zindex-popover" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@zindex-tooltip</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="zindex-tooltip" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@zindex-navbar-fixed</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="zindex-navbar-fixed" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@zindex-modal-background</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="zindex-modal-background" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@zindex-modal</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="zindex-modal" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-xs</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-xs" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-xs-min</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-xs-min" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-phone</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-phone" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-sm</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-sm" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-sm-min</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-sm-min" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-tablet</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-tablet" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-md</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-md" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-desktop-min</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-desktop-min" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-desktop</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-desktop" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-lg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-lg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-lg-desktop-min</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-lg-desktop-min" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-lg-desktop</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-lg-desktop" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-xs-max</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-xs-max" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-sm-max</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-sm-max" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@screen-md-max</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="screen-md-max" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@grid-columns</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="grid-columns" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@grid-gutter-width</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="grid-gutter-width" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@grid-float-breakpoint</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="grid-float-breakpoint" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-collapse-max-height</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-collapse-max-height" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" 222" data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(34, 34, 34);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-link-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-link-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-link-hover-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-link-hover-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-link-hover-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-link-hover-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-link-active-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-link-active-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-link-active-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-link-active-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-link-disabled-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" 444" data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-link-disabled-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(68, 68, 68);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-link-disabled-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-link-disabled-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-brand-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-brand-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-brand-hover-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-brand-hover-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-brand-hover-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-brand-hover-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-toggle-hover-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" 333" data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-toggle-hover-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(51, 51, 51);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-toggle-icon-bar-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-toggle-icon-bar-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@navbar-inverse-toggle-border-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" 333" data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="navbar-inverse-toggle-border-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(51, 51, 51);"></i></span>
                                    </div>
                                    ...
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="pager-border-radius" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    ...
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="pager-disabled-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@modal-inner-padding</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="modal-inner-padding" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@modal-title-padding</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="modal-title-padding" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@modal-title-line-height</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="modal-title-line-height" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@modal-content-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="modal-content-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@modal-content-border-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="modal-content-border-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@modal-content-fallback-border-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" 999" data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="modal-content-fallback-border-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(153, 153, 153);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@modal-backdrop-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" 000" data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="modal-backdrop-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(0, 0, 0);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@modal-header-border-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" e5e5e5" data-color-format="hex" ng-class="{
                                         'input - group color colorpicker'
                                         : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="modal-header-border-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(229, 229, 229);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@modal-footer-border-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="modal-footer-border-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-padding</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-padding" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-border-radius</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-border-radius" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-link-font-weight</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-link-font-weight" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-success-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-success-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-success-text</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-success-text" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-success-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-success-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-info-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-info-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-info-text</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-info-text" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-info-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-info-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-warning-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-warning-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-warning-text</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-warning-text" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-warning-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-warning-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-danger-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-danger-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-danger-text</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-danger-text" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@alert-danger-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="alert-danger-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@progress-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" f5f5f5" data-color-format="hex" ng-class="{
                                         'input-group color colorpicker'
                                         : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="progress-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(245, 245, 245);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@progress-bar-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="progress-bar-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@progress-bar-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="progress-bar-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@progress-bar-success-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="progress-bar-success-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@progress-bar-warning-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="progress-bar-warning-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@progress-bar-danger-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="progress-bar-danger-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@progress-bar-info-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="progress-bar-info-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-inner-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" ddd" data-color-format="hex" ng-class="{
                                         'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="panel-inner-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(221, 221, 221);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-border-radius</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-border-radius" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-footer-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" f5f5f5" data-color-format="hex" ng-class="{
                                         'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="panel-footer-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(245, 245, 245);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-body-padding</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-body-padding" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-default-text</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-default-text" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-default-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" ddd" data-color-format="hex" ng-class="{
                                         'input - group color colorpicker'
                                         : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="panel-default-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(221, 221, 221);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-default-heading-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" f5f5f5" data-color-format="hex" ng-class="{
                                         'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="panel-default-heading-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(245, 245, 245);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-primary-text</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-primary-text" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-primary-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-primary-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-primary-heading-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-primary-heading-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-success-text</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-success-text" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-success-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-success-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-success-heading-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-success-heading-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-warning-text</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-warning-text" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-warning-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-warning-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-warning-heading-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-warning-heading-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-danger-text</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-danger-text" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-danger-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-danger-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-danger-heading-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-danger-heading-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-info-text</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-info-text" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-info-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-info-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@panel-info-heading-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="panel-info-heading-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@thumbnail-padding</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="thumbnail-padding" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@thumbnail-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="thumbnail-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@thumbnail-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" ddd" data-color-format="hex" ng-class="{
                                         'input-group color colorpicker'
                                         : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="thumbnail-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(221, 221, 221);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@thumbnail-border-radius</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="thumbnail-border-radius" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@thumbnail-caption-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="thumbnail-caption-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@thumbnail-caption-padding</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="thumbnail-caption-padding" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@well-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" f5f5f5" data-color-format="hex" ng-class="{
                                         'input - group color colorpicker'
                                         : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="well-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(245, 245, 245);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@well-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="well-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@badge-color:</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="badge-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@badge-link-hover-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="badge-link-hover-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@badge-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="badge-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@badge-active-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="badge-active-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@badge-active-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="badge-active-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@badge-font-weight</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="badge-font-weight" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@badge-line-height</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="badge-line-height" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@badge-border-radius</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="badge-border-radius" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@breadcrumb-padding-vertical</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="breadcrumb-padding-vertical" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@breadcrumb-padding-horizontal</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="breadcrumb-padding-horizontal" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@breadcrumb-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" f5f5f5" data-color-format="hex" ng-class="{
                                         'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="breadcrumb-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(245, 245, 245);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@breadcrumb-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" ccc" data-color-format="hex" ng-class="{
                                         'input-group color colorpicker'
                                         : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="breadcrumb-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(204, 204, 204);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@breadcrumb-active-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="breadcrumb-active-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@breadcrumb-separator</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="breadcrumb-separator" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@carousel-text-shadow</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="carousel-text-shadow" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@carousel-control-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="carousel-control-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@carousel-control-width</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="carousel-control-width" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@carousel-control-opacity</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="carousel-control-opacity" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@carousel-control-font-size</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="carousel-control-font-size" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@carousel-indicator-active-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="carousel-indicator-active-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@carousel-indicator-border-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="carousel-indicator-border-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@carousel-caption-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="carousel-caption-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@close-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" 000" data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="close-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(0, 0, 0);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@close-font-weight</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="close-font-weight" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@close-text-shadow</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="close-text-shadow" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@code-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" c7254e" data-color-format="hex" ng-class="{
                                         'input - group color colorpicker'
                                         : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="code-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(199, 37, 78);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@code-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" f9f2f4" data-color-format="hex" ng-class="{
                                         'input - group color colorpicker'
                                         : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="code-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(249, 242, 244);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@kbd-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="kbd-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@kbd-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" 333" data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="kbd-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(51, 51, 51);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@pre-bg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" f5f5f5" data-color-format="hex" ng-class="{
                                         'input-group color colorpicker'
                                         : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="pre-bg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(245, 245, 245);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@pre-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="pre-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@pre-border-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker" ccc" data-color-format="hex" ng-class="{
                                         'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                         <input name="pre-border-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(204, 204, 204);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@pre-scrollable-max-height</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="pre-scrollable-max-height" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@text-muted</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="text-muted" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@abbr-border-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="abbr-border-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@headings-small-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="headings-small-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@blockquote-small-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="blockquote-small-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@blockquote-border-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="blockquote-border-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden' : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@page-header-border-color</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="page-header-border-color" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@hr-border</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)} input-group color colorpicker"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="hr-border" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i style="background-color: rgb(255, 255, 255);"></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@component-offset-horizontal</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker' : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="component-offset-horizontal" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@container-tablet</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="container-tablet" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@container-desktop</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="container-desktop" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@container-lg-desktop</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="container-lg-desktop" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@container-sm</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input - group color colorpicker'
                                            : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="container-sm" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@container-md</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="container-md" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
                                </div><div ng-repeat="variable in group.data" class="protected form-group ng-scope">
                                    <label class="labelTitle ng-binding">@container-lg</label>                
                                    <div class="input {' ap-color-picker: variable.value': colorpicker(variable.type)}"  data-color-format="hex" ng-class="{
                                            'input-group color colorpicker'
                                                    : colorpicker(variable.type)}" color-picker-apply="">
                                        <input name="container-lg" type="text" data-ng-model="variable.value" class="lessVariable form-control ng-pristine ng-valid" ng-change="autoApplyLess()">
                                        <span class="input-group-addon hidden" ng-class="{
                                                'hidden'
                                                        : !colorpicker(variable.type)}"><i></i></span>
                                    </div>
